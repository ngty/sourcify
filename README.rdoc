...
(TODO: update to reflect ditching of Ripper & RubyLex to use home-baked Ragel based scanner)
...
Currently, irb code parsing doesn't work, you will get Sourcify::CannotParseIrbCodeError
...
Besides its own spec suite, Proc#to_source (static) has been tested to correctly handle:

  ObjectSpace.each_object(Proc) {|o| puts o.to_source }

For:
* Spree (mri-1.8.7 & mri-1.9.1)
