...
Performance is reasonable (but can always be improved on):
  ...
  mri-1.8.7-p299  (w ParseTree)     0.000000  0.000000  1.330000  (  1.350332)
  ree-1.8.7       (w ParseTree)     0.000000  0.000000  1.060000  (  1.079582)
  mri-1.8.7-p299  (static scanner)  0.000000  0.000000  1.440000  (  1.466162)
  mri-1.9.1-p429  (static scanner)  0.010000  0.000000  1.910000  (  1.922684)
  jruby-1.5.2     (static scanner)  9.823000  0.000000  9.823000  (  9.823000)

Seems that I really need to optimize the static code scanner.
...
For projects:
* Spree (mri-1.8.7, mri-1.9.1 & jruby-1.5.2)
