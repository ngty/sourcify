  ...
  should 'handle w do' do
    (
      ...
      s(:iter,
        ...
        nil,
        s(:until, s(:true), s(:iasgn, :@x1, s(:lit, 1)), true))
    )
  end
  ...
  should 'handle w \ do' do
    (
      ...
      s(:iter,
        s(:call, nil, :proc, s(:arglist)),
        nil,
        s(:until, s(:true), s(:iasgn, :@x1, s(:lit, 2)), true))
    )
  end
  ...
  should 'handle wo do (w newline)' do
    (
      ...
      s(:iter,
        s(:call, nil, :proc, s(:arglist)),
        nil,
        s(:until, s(:true), s(:iasgn, :@x1, s(:lit, 3)), true))
    )
  end
  ...
  should 'handle wo do (w semicolon)' do
    (
      ...
      s(:iter,
        s(:call, nil, :proc, s(:arglist)),
        nil,
        s(:until, s(:true), s(:iasgn, :@x1, s(:lit, 4)), true))
    )
  end
  ...
  should 'handle nested wo do within w do' do
    (
      ...
      s(:iter,
        ...
        s(:until,
          s(:true),
          s(:until, s(:true), s(:iasgn, :@x1, s(:lit, 5)), true),
               true))
    )
  end
  ...
  should 'handle nested wo do within wo do' do
    (
      ...
      s(:iter,
        ...
        s(:until,
          s(:true),
          s(:until, s(:true), s(:iasgn, :@x1, s(:lit, 6)), true),
               true))
    )
  end
  ...
  should 'handle nested w do within wo do' do
    (
      ...
      s(:iter,
        ...
        s(:until,
          s(:true),
          s(:until, s(:true), s(:iasgn, :@x1, s(:lit, 7)), true),
               true))
    )
  end
  ...
  should 'handle nested w do within w do' do
    (
      ...
      s(:iter,
        ...
        s(:until,
          s(:true),
          s(:until, s(:true), s(:iasgn, :@x1, s(:lit, 8)), true),
               true))
    )
  end
  ...
  should 'handle simple modifier' do
    (
      ...
      s(:iter,
        s(:call, nil, :proc, s(:arglist)),
        nil,
        s(:until, s(:true), s(:iasgn, :@x1, s(:lit, 9)), true))
    )
  end
  ...
  should 'handle block within modifier' do
    (
      ...
      s(:iter,
        ...
        nil,
        s(:until,
          s(:until, s(:true), s(:iasgn, :@x1, s(:lit, 10)), true),
               s(:iasgn, :@x1, s(:lit, 10)),
               true))
    )
  end
  ...
  should 'handle modifier within block' do
    (
      ...
      s(:iter,
        ...
        s(:until,
          s(:true),
          s(:until, s(:true), s(:iasgn, :@x1, s(:lit, 11)), true),
               true))
    )
  end
